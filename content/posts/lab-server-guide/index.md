---
summary: "通过远程桌面与 SSH 连接实验室 Ubuntu 服务器的操作记录。"
title: 实验室主机连接手册
draft: false
...
2. 安装Remote SSH扩展
   ...
   ![image-20240315204113836](image-20240315204113836.png)

3. `ctrl`+`shift`+`P`打开vscode的选项面板，输入Remote SSH，选择下面的`Remote SSH：Connect to Host`

   ![image-20240315204503444](image-20240315204503444.png)

4. 接着选择二级列表的Configure SSH Hosts，并点击第一项

   ![image-20240315204558732](image-20240315204558732.png)

   ![image-20240315204613146](image-20240315204613146.png)
...
6. 在左侧remote ssh面板下选择你的Host，直接打开或创建新窗口。首次打开选择 Linux系统 - 并输入密码：
   ...
   <!-- <img src="image-20240315205129697.png" alt="image-20240315205129697" style="zoom: 50%;" /> -->
   ![image-20240315205129697](image-20240315205129697.png)

7. 打开后选择open folder即可选择要打开的文件夹：

   ![image-20240315205343964](image-20240315205343964.png)
...
- 如果不想每次都输入密码，尝试在vscode的config文件里添加下面的内容：
  ...
  ![image-20240316213314725](image-20240316213314725.png)
...
4. 运行代码
   ...
   ![image-20240315210434245](image-20240315210434245.png)
